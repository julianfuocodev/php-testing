...
if (isset($_POST['action']) || isset($_GET['action'])) {
    ...
    switch ($action){
        ...
        case("edit"):
            ...
            break;
        case("ordenarmayor"):
                ordenar_mayor($empleados);
                break;
        case("ordenarmenor"):
                ordenar_menor($empleados);
                break;
        case("ordenarrandom"):
                ordenar_random($empleados);
                break;      
        default:
            return_index();
    }
...
//funciones ordenar
function ordenar_mayor($empleados) {
 asort($empleados);
        save_empleados($empleados);
        return_index();
}
function ordenar_menor($empleados) {
arsort($empleados);
        save_empleados($empleados);
        return_index();
   }
function ordenar_random($empleados) {
shuffle($empleados);
        save_empleados($empleados);
        return_index();
   }
